...
public class MixinTrainStatus {
    ...
    @WrapOperation(method = "displayInformation", at = @At(value = "INVOKE", target = "Lcom/simibubi/create/content/trains/entity/TrainStatus;addMessage(Lcom/simibubi/create/content/trains/entity/TrainStatus$StatusMessage;)V"), remap = false)
    private void addPositionInfo(TrainStatus instance, TrainStatus.StatusMessage message, Operation<Void> original) {
        for (Component component : message.messages()) {
