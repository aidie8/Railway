...
public class ConductorScenes {
  ...
  public static ElementLink<EntityElement> makePlayerStand(CreateSceneBuilder scene, String playerName, int leatherColor, Vec3 pos) {
  ...
  public static ElementLink<EntityElement> makeConductor(CreateSceneBuilder scene, DyeColor color, Vec3 pos) {
  ...
  public static void redstoning(SceneBuilder builder, SceneBuildingUtil util) {
    CreateSceneBuilder scene = new CreateSceneBuilder(builder);
  ...
  public static void toolboxing(SceneBuilder builder, SceneBuildingUtil util) {
    CreateSceneBuilder scene = new CreateSceneBuilder(builder);
