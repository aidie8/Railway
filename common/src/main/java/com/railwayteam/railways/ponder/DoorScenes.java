...
import net.createmod.ponder.api.*;
...
//        scene.world().hideSection(lowerFloorCutout, Direction.DOWN);
        ...
        CreateSceneBuilder CreateSceneBuilder = scene;
        ...
        scene.addInstruction(new PonderInstruction() {
            ...
            public void tick(PonderScene scene) {
                scale.tickChaser();
                CreateSceneBuilder.scaleSceneView(scale.getValue());
            }
        });
    ...
    private static void openDoor(CreateSceneBuilder scene, BlockPos bottom) {
    ...
    private static void closeDoor(CreateSceneBuilder scene, BlockPos bottom) {
        scene.world().cycleBlockProperty(bottom, SlidingDoorBlock.OPEN);
        scene.idle(10);
        scene.world().cycleBlockProperty(bottom, SlidingDoorBlock.VISIBLE);
        scene.world().cycleBlockProperty(bottom.above(), SlidingDoorBlock.VISIBLE);
