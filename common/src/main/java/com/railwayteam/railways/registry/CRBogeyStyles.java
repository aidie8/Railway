...
public class CRBogeyStyles {
    ...
    public static final CategoryEntry STANDARD_CATEGORY = registerCategory(Create.ID, "standard");
    ...
    private static Optional<BogeyStyle> getMappedRecursive(BogeyStyle from, TrackType toType, boolean recursive) {
        if (from.getNextBlock(BogeySizes.LARGE) instanceof AbstractBogeyBlock<?>) {
            AbstractBogeyBlock<?> bogeyBlock = from.getNextBlock(BogeySizes.LARGE);
            if (bogeyBlock.getValidPathfindingTypes(from).contains(toType)) {
    ...
    public static Optional<BogeyStyle> getMapped(BogeyStyle from, TrackType toType, boolean forceFit) {
        ...
        if (!forceFit || (toType == TrackType.STANDARD && mapped.isEmpty()))
            return mapped;
        if (mapped.isEmpty() || (mapped.get().getNextBlock(BogeySizes.LARGE) instanceof AbstractBogeyBlock<?>
            && !mapped.get().getNextBlock(BogeySizes.LARGE).getValidPathfindingTypes(mapped.get()).contains(toType))) { // if no (suitable) style found
    ...
    public static final BogeyStyle MONOBOGEY = create("monobogey", "monobogey")
        ...
        .size(BogeySizes.SMALL, CRBlocks.MONO_BOGEY,() ->() -> new BogeyStyle.SizeRenderer(new MonoBogeyRenderer(),StandardBogeyVisual.Small::new))
        .build();
    ...
    public static final BogeyStyle INVISIBLE_MONOBOGEY = create("invisible_monobogey", "monobogey")
        ...
        .size(BogeySizes.SMALL, CRBlocks.INVISIBLE_MONO_BOGEY, ()->() -> new BogeyStyle.SizeRenderer(new InvisibleBogeyRenderer(),StandardBogeyVisual.Small::new))
        .contactParticle(new CubeParticleData())
        .build();
    ...
    public static final BogeyStyle
        SINGLEAXLE = create("singleaxle", SINGLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL,  CRBlocks.SINGLEAXLE_BOGEY,() ->() -> new BogeyStyle.SizeRenderer(new SingleaxleBogeyRenderer(),StandardBogeyVisual.Small::new))
            .build(),
        LEAFSPRING = create("leafspring", SINGLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL,CRBlocks.SINGLEAXLE_BOGEY, () ->() -> new BogeyStyle.SizeRenderer(new LeafspringBogeyRenderer() ,StandardBogeyVisual.Small::new))
            .build(),
        COILSPRING = create("coilspring", SINGLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL,CRBlocks.SINGLEAXLE_BOGEY, () ->() -> new BogeyStyle.SizeRenderer(new CoilspringBogeyRenderer(),StandardBogeyVisual.Small::new))
            .build();

    // Double Axles
    public static final BogeyStyle
        FREIGHT = create("freight", DOUBLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.LARGE_PLATFORM_DOUBLEAXLE_BOGEY,()-> () ->new BogeyStyle.SizeRenderer(new FreightBogeyRenderer(),StandardBogeyVisual.Small::new))
            .build(),
        ARCHBAR = create("archbar", DOUBLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.LARGE_PLATFORM_DOUBLEAXLE_BOGEY,()-> () -> new BogeyStyle.SizeRenderer(new ArchbarBogeyRenderer(),StandardBogeyVisual.Small::new))
            .build(),
        PASSENGER = create("passenger", DOUBLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL , CRBlocks.DOUBLEAXLE_BOGEY, ()-> () -> new BogeyStyle.SizeRenderer(new PassengerBogeyRenderer(),StandardBogeyVisual.Small::new) )
            .build(),
        MODERN = create("modern", DOUBLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.DOUBLEAXLE_BOGEY, () -> ()-> new BogeyStyle.SizeRenderer(new ModernBogeyRenderer(), StandardBogeyVisual.Small::new))
            .build(),
        BLOMBERG = create("blomberg", DOUBLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.DOUBLEAXLE_BOGEY,()-> () -> new BogeyStyle.SizeRenderer(new BlombergBogeyRenderer(),StandardBogeyVisual.Small::new))
            .build(),
        Y25 = create("y25", DOUBLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.LARGE_PLATFORM_DOUBLEAXLE_BOGEY,()->() -> new BogeyStyle.SizeRenderer(new Y25BogeyRenderer(), StandardBogeyVisual.Small::new))
            .build();

    // Triple Axles
    public static final BogeyStyle
        HEAVYWEIGHT = create("heavyweight", TRIPLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.TRIPLEAXLE_BOGEY,()->() -> new BogeyStyle.SizeRenderer(new HeavyweightBogeyRenderer(),StandardBogeyVisual.Small::new ))
            .build(),
        RADIAL = create("radial", TRIPLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL,  CRBlocks.TRIPLEAXLE_BOGEY,()-> () -> new BogeyStyle.SizeRenderer(new RadialBogeyRenderer(),StandardBogeyVisual.Small::new))
            .build();
    ...
    public static final BogeyStyle
        WIDE_DEFAULT = create("wide_default", STANDARD_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL,CRBlocks.WIDE_DOUBLEAXLE_BOGEY,()-> () -> new BogeyStyle.SizeRenderer(new WideDefaultBogeyRenderer(), StandardBogeyVisual.Small::new))
            .size(BogeySizes.LARGE,CRBlocks.WIDE_SCOTCH_BOGEY,()-> () ->new BogeyStyle.SizeRenderer(new  WideScotchYokeBogeyRenderer(), StandardBogeyVisual.Small::new))
            .build(),
        WIDE_COMICALLY_LARGE = create("wide_comically_large",STANDARD_CYCLE_GROUP)
            ...
            .size(BogeySizes.LARGE, CRBlocks.WIDE_COMICALLY_LARGE_BOGEY,()-> () ->new BogeyStyle.SizeRenderer(new WideComicallyLargeScotchYokeBogeyRenderer(),StandardBogeyVisual.Small::new))
            .build();
    ...
    public static final BogeyStyle
        NARROW_DEFAULT = create("narrow_default", STANDARD_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.NARROW_SMALL_BOGEY,()->() -> new BogeyStyle.SizeRenderer(new NarrowSmallBogeyRenderer(),StandardBogeyVisual.Small::new ))
            .size(BogeySizes.LARGE,  CRBlocks.NARROW_SCOTCH_BOGEY, ()-> () ->new BogeyStyle.SizeRenderer(new NarrowScotchYokeBogeyRenderer(),StandardBogeyVisual.Small::new))
            .build(),
        NARROW_DOUBLE_SCOTCH = create("narrow_double_scotch",STANDARD_CYCLE_GROUP)
            ...
            .size(BogeySizes.LARGE, CRBlocks.NARROW_DOUBLE_SCOTCH_BOGEY,()-> () -> new BogeyStyle.SizeRenderer(new NarrowDoubleScotchYokeBogeyRenderer(),StandardBogeyVisual.Small::new))
            .build();

    // Handcar
    public static final BogeyStyle HANDCAR = create("handcar", "handcar_cycle_group")
        .size(BogeySizes.SMALL,  CRBlocks.HANDCAR,()-> ()-> new BogeyStyle.SizeRenderer(new HandcarBogeyRenderer(),StandardBogeyVisual.Small::new))
    ...
    public static final BogeyStyle
        MEDIUM_STANDARD = create("medium_standard", DOUBLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_BOGEY, () -> () -> new BogeyStyle.SizeRenderer(new MediumStandardRenderer(), StandardBogeyVisual.Small::new))
            .build(),
        MEDIUM_SINGLE_WHEEL = create("medium_single_wheel", SINGLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_BOGEY, () ->() -> new BogeyStyle.SizeRenderer(new MediumSingleWheelRenderer(),StandardBogeyVisual.Small::new))
            .build(),
        MEDIUM_TRIPLE_WHEEL = create("medium_triple_wheel", TRIPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_TRIPLE_WHEEL,() ->() ->  new BogeyStyle.SizeRenderer(new MediumTripleWheelRenderer(),StandardBogeyVisual.Small::new))
            .build(),
        MEDIUM_QUADRUPLE_WHEEL = create("medium_quadruple_wheel", QUADRUPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_QUADRUPLE_WHEEL, () ->() ->new BogeyStyle.SizeRenderer(new MediumQuadrupleWheelRenderer(),StandardBogeyVisual.Small::new))
            .build(),
        MEDIUM_QUINTUPLE_WHEEL = create("medium_quintuple_wheel", QUINTUPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL,CRBlocks.MEDIUM_QUINTUPLE_WHEEL, () ->()-> new BogeyStyle.SizeRenderer(new MediumQuintupleWheelRenderer(), StandardBogeyVisual.Small::new))
            .build(),
        MEDIUM_2_0_2_TRAILING = create("medium_2_0_2_trailing", SINGLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL,CRBlocks.MEDIUM_2_0_2_TRAILING,()-> () -> new BogeyStyle.SizeRenderer(new Medium202TrailingRenderer(), StandardBogeyVisual.Small::new))
            .build(),
        MEDIUM_4_0_4_TRAILING = create("medium_4_0_4_trailing", DOUBLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL,CRBlocks.MEDIUM_4_0_4_TRAILING,()-> () -> new BogeyStyle.SizeRenderer(new Medium404TrailingRenderer(),StandardBogeyVisual::new) )
            .build(),
        MEDIUM_6_0_6_TRAILING = create("medium_6_0_6_trailing", TRIPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL,CRBlocks.MEDIUM_TRIPLE_WHEEL,()-> () -> new BogeyStyle.SizeRenderer(new Medium606TrailingRenderer(),StandardBogeyVisual::new) )
            .build(),
        MEDIUM_6_0_6_TENDER = create("medium_6_0_6_tender", TRIPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL,CRBlocks.MEDIUM_TRIPLE_WHEEL,()-> () -> new BogeyStyle.SizeRenderer(new Medium606TenderRenderer(),StandardBogeyVisual::new) )
            .build(),
        MEDIUM_8_0_8_TENDER = create("medium_8_0_8_tender", QUADRUPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL,CRBlocks.MEDIUM_QUADRUPLE_WHEEL,()-> () -> new BogeyStyle.SizeRenderer(new Medium808TenderRenderer(),StandardBogeyVisual::new) )
            .build(),
        MEDIUM_10_0_10_TENDER = create("medium_10_0_10_tender", QUINTUPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL,CRBlocks.MEDIUM_QUINTUPLE_WHEEL,()-> () -> new BogeyStyle.SizeRenderer(new Medium10010TenderRenderer(),StandardBogeyVisual::new) )
            .build();
    ...
    public static final BogeyStyle
        LARGE_CREATE_STYLED_0_4_0 = create("large_create_style_0_4_0", DOUBLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.LARGE,CRBlocks.LARGE_CREATE_STYLE_0_4_0 ,()-> () -> new BogeyStyle.SizeRenderer(new LargeCreateStyled040Renderer(),StandardBogeyVisual::new) )
            .build(),
        LARGE_CREATE_STYLED_0_6_0 = create("large_create_style_0_6_0", TRIPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.LARGE,CRBlocks.LARGE_CREATE_STYLE_0_6_0 ,()-> () -> new BogeyStyle.SizeRenderer(new LargeCreateStyled060Renderer(),StandardBogeyVisual::new) )
            .build(),
        LARGE_CREATE_STYLED_0_8_0 = create("large_create_style_0_8_0", QUADRUPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.LARGE,CRBlocks.LARGE_CREATE_STYLE_0_8_0 ,()-> () -> new BogeyStyle.SizeRenderer(new LargeCreateStyled080Renderer(),StandardBogeyVisual::new) )
            .build(),
        LARGE_CREATE_STYLED_0_10_0 = create("large_create_style_0_10_0", QUINTUPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.LARGE, CRBlocks.LARGE_CREATE_STYLE_0_10_0 ,()->() -> new BogeyStyle.SizeRenderer(new LargeCreateStyled0100Renderer(),StandardBogeyVisual::new) )
            .build(),
        LARGE_CREATE_STYLED_0_12_0 = create("large_create_style_0_12_0", SEXTUPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.LARGE, CRBlocks.LARGE_CREATE_STYLE_0_12_0 ,()->() -> new BogeyStyle.SizeRenderer(new LargeCreateStyled0120Renderer(),StandardBogeyVisual::new) )
            .build();
